    ...
    TasksAddComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function TasksAddComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup.enter", function TasksAddComponent_Template_input_keyup_enter_6_listener($event) {
  ...
  function srcAppTasksTasksListTasksListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TasksListComponent_li_6_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TasksListComponent_li_6_Template_input_change_2_listener($event) {
